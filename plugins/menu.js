...
> ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ *${botName}* ✨`.trim();
    ...
    try {
      // Sending Image with Caption and Interactive Buttons / Native Flow
        ...
        buttons: [{
          ...
          sections: [{
            ...
            rows: [{
              header: '',
              title: '👤 Owner Info',
              description: 'Get developer & owner details',
              id: `${prefix}owner`
            }]
          }, {
            title: '✨ Information',
      ...
      // Fallback to text reply if image/button sending fails
      await reply(caption);
    }
