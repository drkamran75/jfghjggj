...
module.exports = {
    name: "moviebox",
    aliases: ["mbox", "movieboxdl"],
    category: "downloader",
    description: "Search and download movies/series from MovieBox via API",
                ...
                try {
                    ...
                    const downloadHandler = async (up) => {
                        try {
                            ...
                            // ⚡ FIX: Ultra Safe URL Extraction from Mirror object
                            ...
                            // Agar phir bhi URL na miley toh crash hone ke bajaye warning de
                            if (!targetFileUrl) {
                                await react("❌");
                            ...
                            // ⚡ FIX: Safe Thumbnail Handling to prevent Baileys .toString() crash
                            ...
                            // Agar thumbnail valid buffer hai tabhi append karo, varna chhor do
